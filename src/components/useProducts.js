...
return{
    ...
    onAddCart : async(product) => {
      ...
      buy:(value) => {
          History.push('/AllInOneKasi-online-vegetable-shopping-reactjs/'+value);
      },
                ...
                if(res){
                    ...
                    userCartItem.get().then(function(doc) {
                        ...
                        if(user.email===null){
                            ...
                            History.push('/AllInOneKasi-online-vegetable-shopping-reactjs');
                                }
                            } 
      ...
      signUp:(e)=>{
            ...
            if(pwdLogin === cnfPwdLogin){
                if(user.email!==null){
                    ...
                    if(res){
                        History.push('/AllInOneKasi-online-vegetable-shopping-reactjs/products')
                    }
                    })
                    .catch((err)=>{
                        console.log(err)
